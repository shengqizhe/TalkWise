...
> **更新约定**：每次有新的功能、修复或结构调整，同步更新本 README 与 [CHANGELOG.md](./CHANGELOG.md)。
...
| 文档 | 说明 |
|---|---|
| [CHANGELOG.md](./CHANGELOG.md) | 变更日志：新特性 / 变更 / 修复，按提交记录 |
| [docs/agent-改造方案.md](./docs/agent-改造方案.md) | Agent 模块设计、场景轨迹、数据设计、实施阶段 |

---

## 🔀 分支与提交约定

- **分支**：`main`（稳定）/ `kf`（日常开发），每次提交同步推送两个分支
- **提交信息**：说明"改了什么、为什么"（分模块描述）
- **文档同步**：功能变更 → 更新 `CHANGELOG.md`；功能或用法有变化 → 同时更新本 README
